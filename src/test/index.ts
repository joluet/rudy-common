...
describe('buildConnections function', () => {
  ...
  it('should construct ferry connections', () => {
    ...
    const routeState: RouteState = [
      { id: 'id-1', position: 0 },
      { id: 'id-1*id-4-name2', position: 1 },
      { id: 'id-1*id-4-name3', position: 2 },
      { id: 'id-4', position: 3 }
    ]
    const expectedConnections: Connection[] = [
      {
  ...
  it('should also work with more than one ferry', () => {
    const stops: RouteStop[] = [
      ...
      },
      {
        ...
        lat: 3.0,
        lng: 3.3,
        itemType: ItemType.FerryTerminalTransit
      },
      {
        id: 'id-1*id-5-name4',
        placeId: 'place-4',
    ...
    const routeState: RouteState = [
      { id: 'id-1', position: 0 },
      { id: 'id-1*id-5-name2', position: 1 },
      { id: 'id-1*id-5-name3', position: 2 },
      { id: 'id-1*id-5-name4', position: 3 },
      { id: 'id-5', position: 4 },
    ]
    const expectedConnections: Connection[] = [
      {
