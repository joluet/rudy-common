...
exports.calculateMetricsSums = exports.buildConnections = exports.getToFerryTerminalConnectionId = exports.mergeRouteStates = exports.TransitType = exports.RouteUserRole = exports.ItemType = void 0;
...
exports.buildConnections = (routeStops, routeState) => {
    return routeStops
        ...
        if (index < array.length - 1) {
            ...
            if (origin.itemType === types_1.ItemType.FerryTerminalDeparture) {
                result.push({
            ...
            else if (origin.itemType === types_1.ItemType.FerryTerminalTransit) {
                result.push({
                    id: `${origin.id}*${destination.name.replace(/ /g, '')}`,
                    origin: origin,
                    destination: destination,
